...
`https://github.com/Hack_Training/Microsoft-Activation-Scripts/archive/refs/heads/master.zip`  
or  
`https://git.activated.win/Hack_Training/Microsoft-Activation-Scripts/archive/master.zip`
